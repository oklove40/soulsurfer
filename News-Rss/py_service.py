...
class aservice(win32serviceutil.ServiceFramework):
   ...
   def SvcDoRun(self):
      ...
      self.timeout = 60000     #60 seconds / 1 minutes
      ...
      while 1:
         ...
         if rc == win32event.WAIT_OBJECT_0:
            ...
            try:
               file_path = "C:\"python_workspace\"soulsurfer\"News-Rss\"coinnessRss.py"
               execfile(file_path)             #Execute the script

               # inc_file_path2 = "C:\python_workspace\soulsurfer\News-Rss\coinnessRss.py"
